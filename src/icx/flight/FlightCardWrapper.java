...
public class FlightCardWrapper {
     ...
     *
     */
    public static void getFlights(JPanel AirlineCardContainer, JComboBox<String> comboBox, String name, String code) {

        String country = (String) comboBox.getSelectedItem();
        StringBuilder queryBuilder = new StringBuilder("SELECT * FROM `Flights`");
