 ...
 * @author sandaruwan
 */
public class UpdateAircraftType extends javax.swing.JDialog {
     ...
     */
    public UpdateAircraftType(JFrame parent, boolean modal, String action) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Update Aircraft Type");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateAircraftType.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                UpdateAircraftType dialog = new UpdateAircraftType(new javax.swing.JFrame(), true, "Action");
