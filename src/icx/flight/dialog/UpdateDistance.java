...
//    private String code;
    ...
    public UpdateDistance(JFrame parent, boolean modal, String action, int distanceId, String departureAirport, String arrivalAirport, double distance, Date date, Time time) {
        super(parent, action, modal);
        initComponents();
        airportDAO = new AirportDAO();
        distanceDAO = new DistanceDAO();
    ...
    private void initComponents() {
        ...
        processUpdate = new javax.swing.JButton();
        ...
        processUpdate.setText("Update");
        processUpdate.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                processUpdateActionPerformed(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(processUpdate, javax.swing.GroupLayout.PREFERRED_SIZE, 90, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(25, 25, 25))
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(processUpdate, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void processUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_processUpdateActionPerformed
        // TODO add your handling code here:
        if (air1.getSelectedIndex() == 0) {
            ...
            try {
                ...
                dao.updateDistance(dto);
                JOptionPane.showMessageDialog(this, "Distance updated successfully.");
                dispose();
                LoggerUtil.logInfo("THE RECORDE:: " + dto.getAirport1Id() + " TO " + dto.getAirport2Id() + " WAS SUCCESSFULLY UPDATED AT: " + dto.getCalculationDate() + " TO " + dto.getDistance() + "|| REFERENCE::" + dto.getId());
                this.dispose();
    ...
    }//GEN-LAST:event_processUpdateActionPerformed
    ...
    private javax.swing.JButton processUpdate;
