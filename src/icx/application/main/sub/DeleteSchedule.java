...
public class DeleteSchedule extends javax.swing.JDialog {
    ...
    public DeleteSchedule(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Delete Flight Schedule");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Flight No", "Departure", "Arrival", "Date", "Departure Time", "Arrival Time"
            }
        ) {
    ...
    private void jTextField1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyReleased
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            String flightNo = jTextField1.getText();
            ...
            try {
                ...
                ResultSet resultset = MySQL.execute(""
                        ...
                        + "INNER JOIN `airlines` ON `airlines`.`airline_id` = `flights`.`airline_id` WHERE `flight_schedule`.`flight_id` = '" + flightNo + "' ORDER BY `id` ASC");
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (evt.getClickCount() == 2) {
            JOptionPane.showMessageDialog(this, "Do you want to cancel this schedule?", "conformation", JOptionPane.YES_NO_OPTION);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DeleteSchedule dialog = new DeleteSchedule(new javax.swing.JFrame(), true);
